...
#define REMOTE_COAP_INFO        "218.4.33.71,5683"
...
{
  SUB_NONE,
  SUB_SYNC,/* Start AT SYNC: Send AT every 1s, if receive OK, SYNC success, if no OK return after sending AT 10 times, SYNC fail */
  SUB_CMEE,/* Use AT+CMEE=1 to enable result code and use numeric values */
  SUB_CFUN,/*设置终端rf射频是否打开*/
  SUB_CIMI,/*查询估计移动设备身份码*/
  SUB_CGSN,/*查询模块序列号*/
  SUB_CEREG,/*查询网络注册状态*/
  SUB_CSCON,/*查询信号连接状态*/
  SUB_CGATT,/*ps连接或者分离*/
